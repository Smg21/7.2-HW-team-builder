...
- [✔️] `cd` into the cloned project directory
- [✔️] Use `npx create-react-app .` (NOTE THE PERIOD AT THE END!) to initiate the project.
- [✔️] Start up the app using `npm start`
- [✔️] Implement the project on your newly created `main` branch, committing changes regularly.
